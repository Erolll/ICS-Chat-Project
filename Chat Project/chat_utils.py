...
menu = "\n++++ Choose one of the following commands\n \
        ...
        \n \
        =bNews: to bring up current Financial News\n \
        =bWorld: to bring up current World Indeces\n \
        =bCryptocurrencies: to bring up current Cryptocurrencies\n \
        =bCommodities: to bring current Commodities\n \
        \n \
        =bp: list portfolio\n \
        =pc: clear portfolio\n \
        =pTCKR: add financial info on TCKR to portfolio\n \
        =bTCKR: to find financial info on TCKR\n\n"
